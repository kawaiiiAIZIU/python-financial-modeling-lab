...
chapter1 = notebook(
    [
        md(
            ...
            > **故事起点**：一名大学生有10,000元暂时不用。这笔钱可以放在现金账户、借给某个可靠发行者、购买企业的一小部分，或者通过基金持有一篮子资产。不同选择到底改变了什么？
        ...
        md(
            ...
            如果你把10,000元借给同学一年，约定一年后收回10,500元：
        ...
        md(
            ...
            站在你的角度，今天付出10,000元记为负现金流，一年后收到10,500元记为正现金流：
