...
## 本章导航：小林把未来学习资金放进一份付款合同

小林计划三年后支付一笔学习费用。在教学模拟市场中，他看到一只固定利率债券：先读懂合同现金流，再研究市场利率变化，最后检查合同之外的风险。

![小林理解债券现金流与利率风险](assets/course/03_bond_mechanism.png)
...
**章间产出**：保存一张“小林债券风险卡”，包含现金流、当前价格、±50/100/200 bp压力结果和模型未覆盖的风险；第4章用它与股权资产比较。
""",
        "cards": {
            "AI学习状态": task_card(
...
## 本章导航：小林从“借钱给企业”走向“持有企业的一部分”

第3章的小林是债权人；本章他比较成为股东、通过基金持有一篮子资产，以及一笔订单如何在市场中真正成交。

![小林理解股票、基金与市场成交机制](assets/course/04_market_mechanism.png)
...
**章间产出**：保存“小林市场记录”，包含两个指数、基金NAV、800股逐档成交明细和成本分解；第5章将把这些记录当作待审计数据。
""",
        "cards": {
            "AI学习状态": task_card(
                "核心｜检索练习", "债权人与股东分别拥有什么权利、承担什么风险？",
                "回忆第3章固定合同现金流和发行人风险。",
                "买入股票后，企业是否欠小林一笔固定本金？先用一句话说明。",
...
## 本章导航：小林下载了一张“看起来很整齐”的价格表

小林准备比较第4章的资产与交易记录，却发现一条数值的对象、单位、观测时间、发布时间和清洗历史，往往比数值本身更重要。

![小林审计金融数据与时间边界](assets/course/05_data_pipeline.png)
